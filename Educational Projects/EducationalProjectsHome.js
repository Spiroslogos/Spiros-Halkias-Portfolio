...
projects.forEach((projects) => {
    ...
    `<div class="projectbox-div">
        <div class="imgbutton-div">
            ...
            <button class="imgbutton-button" id="${projects.button}">
                View Project
            </button>
        </div>
        <div class="text-div">
...
document.getElementById('accessrobot').addEventListener('click', function() {
    window.location.href = "Autonomous Robot Project/AutonomousRobotProject.html"
    });
